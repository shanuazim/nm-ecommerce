...
var icons = ["achievable-dot", "add", "alert", "arrow-down", "arrow-left", "arrow-right", "arrow-up", "bill-due", "book", "bookmark-solid", "bookmark", "bullet", "calendar", "caret-down", "caret-left", "caret-right", "caret-up", "check", "close", "cloud", "collapse", "date", "document-stack", "document", "download", "edit", "exit", "expand", "fail", "gps", "help", "info", "issue-credit", "lock", "new-window", "newspaper", "notification-alt", "notification", "options", "pdf", "permissions", "plus", "refresh", "remove", "salesforce", "search", "settings", "sort", "split", "star", "success", "suitcase", "sync", "template-library", "unlock", "upload", "vertical-ellipses"],
    themeKey = "lv-px";
...
var icons = ["achievable-dot", "add", "alert", "arrow-down", "arrow-left", "arrow-right", "arrow-up", "bill-due", "bookmark-solid", "bookmark", "bullet", "caret-down", "caret-left", "caret-right", "caret-up", "check", "close", "collapse", "date", "document-stack", "document", "download", "edit", "email", "exit", "expand", "fail", "gps", "grid-view", "help", "home", "info", "investments", "list-view", "lock", "new-window", "newspaper", "notification", "options", "paperless", "pdf", "plus", "refresh", "remove", "save", "scroll-left", "search", "settings", "share", "sidepanel", "sort", "split", "star", "success", "suitcase", "sync", "sysicon-downloadalt", "sysicon-fileandfolder", "sysicon-folder", "sysicon-lock", "sysicon-multipledocument", "sysicon-search", "sysicon-trash", "unlock", "upload", "vertical-ellipses"],
    themeKey = "nm-px";
